...
### Senior Angular & Frontend Engineer · Bhopal, India 🇮🇳
...
- 🏢 **Senior Software Engineer** at **Taazaa Inc**, Noida *(March 2024 – Present)*
- ⚡ **7+ years** building high-performance web apps with Angular & TypeScript
- 🏗️ Specialist in **NX Monorepos**, **NgRx state management**, and **design systems**
- 🎨 Built a Storybook-driven component library adopted across **3 product teams**, cutting QA UI bugs by ~50%
- 🧪 Took Cypress E2E coverage from **0% → 70%** on a large-scale frontend
- 👥 Mentored **4 junior developers**, 2 of whom received promotions within the year
- 🗣️ Love running internal tech talks, code reviews, and lifting the whole team's quality bar
...
| ⏳ Experience | 🚀 Projects | 🏢 Enterprise Apps | 👥 Teams Led |
|:---:|:---:|:---:|:---:|
| **7+ Years** | **20+ Delivered** | **5 Applications** | **3 Mentored** |
...
**⚡ Angular & Core — Primary Expertise**

![Angular](https://img.shields.io/badge/Angular_v8–v19-DD0031?style=flat-square&logo=angular&logoColor=white)
...
![Signals](https://img.shields.io/badge/Signals_(v17+)-DD0031?style=flat-square&logo=angular&logoColor=white)
...
| Period | Company | Role |
|--------|---------|------|
| Mar 2024 – Present | 🌐 **Taazaa Inc**, Noida | Senior Software Engineer |
| May 2022 – Feb 2024 | 🖥️ **WebMobril Technologies**, Noida | Senior Web Developer |
| Mar 2020 – Apr 2022 | 🔧 **Benchwork Technologies**, Noida | Full Stack Web Developer |
| Oct 2019 – Feb 2020 | 💡 **Plebiscite IT Services**, Noida | Angular Developer |
| Jan 2019 – Sep 2019 | 🌱 **MSS Infotech**, Noida | Web Developer |
